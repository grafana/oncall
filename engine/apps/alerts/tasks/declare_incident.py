...
def _attach_alert_group_to_incident(alert_group, incident_id, escalation_policy, attached=False):
    ...
    AlertGroupLogRecord.objects.create(
        ...
        step_specific_info={"incident_id": incident_id},
...
def declare_incident(alert_group_pk, escalation_policy_pk):
    ...
    if existing_incident:
        ...
        try:
            ...
            if incident_data["status"] == DEFAULT_INCIDENT_STATUS:
                ...
                _attach_alert_group_to_incident(alert_group, incident_id, escalation_policy, attached=True)
            else:
                existing_incident.is_opened = False
                existing_incident.save(update_fields=["is_opened"])
    ...
    if existing_incident is None or not existing_incident.is_opened:
        ...
        try:
            ...
            _attach_alert_group_to_incident(alert_group, incident_data["incidentID"], escalation_policy)
