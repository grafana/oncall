...
from apps.social_auth.backends import SLACK_INSTALLATION_BACKEND, LoginMattermostOAuth2, LoginSlackOAuth2V2, LoginZoomOAuth2
...
@api_view(["GET"])
@authentication_classes([GoogleTokenAuthentication, SlackTokenAuthentication, MattermostTokenAuthentication, ZoomTokenAuthentication])
@never_cache
@csrf_exempt
@psa("social:complete")
def overridden_complete_social_auth(request: Request, backend: str, *args, **kwargs) -> Response:
    ...
    if return_to is None:
        ...
        return_to = (
            ...
            if isinstance(request.backend, (LoginMattermostOAuth2, LoginSlackOAuth2V2, LoginZoomOAuth2, GoogleOAuth2))
