...
def test_alert_receive_channel_create_permissions(
    ...
    url = reverse("api-internal:alert_receive_channel-list")
    with patch(
        "apps.api.views.v1.alert_receive_channel.AlertReceiveChannelView.create",
...
def test_alert_receive_channel_update_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_receive_channel.AlertReceiveChannelView.update",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_alert_receive_channel_delete_permissions(
    ...
    url = reverse("api-internal:alert_receive_channel-detail", kwargs={"pk": alert_receive_channel.public_primary_key})
    with patch(
        "apps.api.views.v1.alert_receive_channel.AlertReceiveChannelView.destroy",
        return_value=Response(
...
def test_alert_receive_channel_list_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_receive_channel.AlertReceiveChannelView.list",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_alert_receive_channel_detail_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_receive_channel.AlertReceiveChannelView.retrieve",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_alert_receive_channel_send_demo_alert_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_receive_channel.AlertReceiveChannelView.send_demo_alert",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_alert_receive_channel_integration_options_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_receive_channel.AlertReceiveChannelView.integration_options",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_alert_receive_channel_preview_template_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_receive_channel.AlertReceiveChannelView.preview_template",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_alert_receive_channel_change_team_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_receive_channel.AlertReceiveChannelView.change_team",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_alert_receive_channel_counters_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_receive_channel.AlertReceiveChannelView.counters",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_alert_receive_channel_counters_per_integration_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_receive_channel.AlertReceiveChannelView.counters_per_integration",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
