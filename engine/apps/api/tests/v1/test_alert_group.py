...
def test_alert_group_acknowledge_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_group.AlertGroupView.acknowledge",
...
def test_alert_group_unacknowledge_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_group.AlertGroupView.unacknowledge",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_alert_group_resolve_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_group.AlertGroupView.resolve",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_alert_group_unresolve_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_group.AlertGroupView.unresolve",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_alert_group_silence_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_group.AlertGroupView.silence",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_alert_group_unsilence_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_group.AlertGroupView.unsilence",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_alert_group_attach_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_group.AlertGroupView.attach",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_alert_group_unattach_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_group.AlertGroupView.unattach",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_alert_group_list_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_group.AlertGroupView.list",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_alert_group_stats_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_group.AlertGroupView.stats",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_alert_group_bulk_action_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_group.AlertGroupView.bulk_action", return_value=Response(status=status.HTTP_200_OK)
    ):
        response = client.post(url, format="json", **make_user_auth_headers(user, token))
...
def test_alert_group_filters_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_group.AlertGroupView.filters",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_alert_group_detail_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_group.AlertGroupView.retrieve",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_alert_group_preview_template_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_group.AlertGroupView.preview_template",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
