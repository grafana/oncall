...
def test_custom_button_create_permissions(
    ...
    with patch(
        "apps.api.views.v1.custom_button.CustomButtonView.create",
...
def test_custom_button_update_permissions(
    ...
    with patch(
        "apps.api.views.v1.custom_button.CustomButtonView.update",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_custom_button_list_permissions(
    ...
    with patch(
        "apps.api.views.v1.custom_button.CustomButtonView.list",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_custom_button_retrieve_permissions(
    ...
    with patch(
        "apps.api.views.v1.custom_button.CustomButtonView.retrieve",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_custom_button_delete_permissions(
    ...
    with patch(
        "apps.api.views.v1.custom_button.CustomButtonView.destroy",
        return_value=Response(
