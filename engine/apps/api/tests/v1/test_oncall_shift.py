...
def test_on_call_shift_create_permissions(
    ...
    with patch(
        "apps.api.views.v1.on_call_shifts.OnCallShiftView.create",
...
def test_on_call_shift_update_permissions(
    ...
    with patch(
        "apps.api.views.v1.on_call_shifts.OnCallShiftView.update",
        return_value=Response(
...
def test_on_call_shift_list_permissions(
    ...
    with patch(
        "apps.api.views.v1.on_call_shifts.OnCallShiftView.list",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_on_call_shift_retrieve_permissions(
    ...
    with patch(
        "apps.api.views.v1.on_call_shifts.OnCallShiftView.retrieve",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_on_call_shift_delete_permissions(
    ...
    with patch(
        "apps.api.views.v1.on_call_shifts.OnCallShiftView.destroy",
        return_value=Response(
...
def test_on_call_shift_frequency_options_permissions(
    ...
    with patch(
        "apps.api.views.v1.on_call_shifts.OnCallShiftView.frequency_options",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_on_call_shift_days_options_permissions(
    ...
    with patch(
        "apps.api.views.v1.on_call_shifts.OnCallShiftView.days_options",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
