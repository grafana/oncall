...
def test_get_slack_settings_permissions(
    ...
    with patch(
        "apps.api.views.v1.slack_team_settings.SlackTeamSettingsAPIView.get",
...
def test_update_slack_settings_permissions(
    ...
    url = reverse("api-internal:slack-settings")
    with patch(
        "apps.api.views.v1.slack_team_settings.SlackTeamSettingsAPIView.put",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_get_acknowledge_remind_options_permissions(
    ...
    with patch(
        "apps.api.views.v1.slack_team_settings.AcknowledgeReminderOptionsAPIView.get",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_get_unacknowledge_timeout_options_permissions(
    ...
    with patch(
        "apps.api.views.v1.slack_team_settings.UnAcknowledgeTimeoutOptionsAPIView.get",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
