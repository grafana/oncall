...
def test_channel_filter_create_permissions(
    ...
    with patch(
        "apps.api.views.v1.channel_filter.ChannelFilterView.create",
...
def test_channel_filter_update_permissions(
    ...
    with patch(
        "apps.api.views.v1.channel_filter.ChannelFilterView.update",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_channel_filter_list_permissions(
    ...
    with patch(
        "apps.api.views.v1.channel_filter.ChannelFilterView.list",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_channel_filter_retrieve_permissions(
    ...
    with patch(
        "apps.api.views.v1.channel_filter.ChannelFilterView.retrieve",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_channel_filter_delete_permissions(
    ...
    with patch(
        "apps.api.views.v1.channel_filter.ChannelFilterView.destroy",
        return_value=Response(
...
def test_channel_filter_move_to_position_permissions(
    ...
    with patch(
        "apps.api.views.v1.channel_filter.ChannelFilterView.move_to_position",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_alert_receive_channel_send_demo_alert_permissions(
    ...
    with patch(
        "apps.api.views.v1.channel_filter.ChannelFilterView.send_demo_alert",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_channel_filter_update_notification_backends_updates_existing_data(
    ...
    with patch("apps.api.serializers.v1.channel_filter.get_messaging_backend_from_id") as mock_get_backend:
