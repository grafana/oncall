...
from apps.api.views.v1.webhooks import RECENT_RESPONSE_LIMIT, WEBHOOK_URL
...
@mock.patch("apps.api.views.v1.webhooks.WebhooksView.check_webhooks_2_enabled")
@pytest.mark.django_db
...
def test_webhook_create_permissions(
    ...
    with patch(
        "apps.api.views.v1.webhooks.WebhooksView.create",
...
def test_webhook_update_permissions(
    ...
    with patch(
        "apps.api.views.v1.webhooks.WebhooksView.update",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_webhook_list_permissions(
    ...
    with patch(
        "apps.api.views.v1.webhooks.WebhooksView.list",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_webhook_retrieve_permissions(
    ...
    with patch(
        "apps.api.views.v1.webhooks.WebhooksView.retrieve",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_webhook_delete_permissions(
    ...
    with patch(
        "apps.api.views.v1.webhooks.WebhooksView.destroy",
        return_value=Response(
