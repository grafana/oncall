...
def test_alert_receive_channel_template_update_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_receive_channel_template.AlertReceiveChannelTemplateView.update",
...
def test_alert_receive_channel_template_detail_permissions(
    ...
    with patch(
        "apps.api.views.v1.alert_receive_channel_template.AlertReceiveChannelTemplateView.retrieve",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_update_alert_receive_channel_backend_template_update_values(
    ...
    with patch(
        "apps.api.serializers.v1.alert_receive_channel.get_messaging_backends",
