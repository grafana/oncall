...
def test_escalation_policy_create_permissions(
    ...
    with patch(
        "apps.api.views.v1.escalation_policy.EscalationPolicyView.create",
...
def test_escalation_policy_update_permissions(
    ...
    with patch(
        "apps.api.views.v1.escalation_policy.EscalationPolicyView.update",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_escalation_policy_list_permissions(
    ...
    with patch(
        "apps.api.views.v1.escalation_policy.EscalationPolicyView.list",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_escalation_policy_retrieve_permissions(
    ...
    with patch(
        "apps.api.views.v1.escalation_policy.EscalationPolicyView.retrieve",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_escalation_policy_delete_permissions(
    ...
    with patch(
        "apps.api.views.v1.escalation_policy.EscalationPolicyView.destroy",
        return_value=Response(
...
def test_escalation_policy_escalation_options_permissions(
    ...
    with patch(
        "apps.api.views.v1.escalation_policy.EscalationPolicyView.escalation_options",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_escalation_policy_delay_options_permissions(
    ...
    with patch(
        "apps.api.views.v1.escalation_policy.EscalationPolicyView.delay_options",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_escalation_policy_move_to_position_permissions(
    ...
    with patch(
        "apps.api.views.v1.escalation_policy.EscalationPolicyView.move_to_position",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
