...
@patch(
    "apps.api.views.v1.resolution_note.ResolutionNoteView.create",
...
@patch(
    "apps.api.views.v1.resolution_note.ResolutionNoteView.update",
    return_value=Response(
        status=status.HTTP_200_OK,
        data={},  # mock data with empty dict to satisfy overridden dispatch method in ResolutionNoteView
    ),
...
@patch(
    "apps.api.views.v1.resolution_note.ResolutionNoteView.destroy",
...
@patch(
    "apps.api.views.v1.resolution_note.ResolutionNoteView.list",
    return_value=Response(
        status=status.HTTP_200_OK,
    ),
)
...
@patch(
    "apps.api.views.v1.resolution_note.ResolutionNoteView.retrieve",
    return_value=Response(
        status=status.HTTP_200_OK,
    ),
)
