...
@patch(
    "apps.api.serializers.v1.integration_heartbeat.IntegrationHeartBeatSerializer.get_instruction",
    return_value="<p>Grafana instruction<p>",
)
@patch(
    "apps.api.serializers.v1.integration_heartbeat.IntegrationHeartBeatSerializer._last_heartbeat_time_verbal",
...
def test_integration_heartbeat_create_permissions(
    ...
    with patch(
        "apps.api.views.v1.integration_heartbeat.IntegrationHeartBeatView.create",
...
def test_integration_heartbeat_update_permissions(
    ...
    with patch(
        "apps.api.views.v1.integration_heartbeat.IntegrationHeartBeatView.update",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_integration_heartbeat_list_permissions(
    ...
    with patch(
        "apps.api.views.v1.integration_heartbeat.IntegrationHeartBeatView.list",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_integration_heartbeat_timeout_options_permissions(
    ...
    with patch(
        "apps.api.views.v1.integration_heartbeat.IntegrationHeartBeatView.timeout_options",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
...
def test_integration_heartbeat_retrieve_permissions(
    ...
    with patch(
        "apps.api.views.v1.integration_heartbeat.IntegrationHeartBeatView.retrieve",
        return_value=Response(
            status=status.HTTP_200_OK,
        ),
    ):
