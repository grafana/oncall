...
from .views.paging import CheckUserAvailability, DirectPagingAPIView, UnpageUserAPIView
...
urlpatterns = [
    ...
    # Direct paging
    # TODO: probably move check_user_availability to user view action & unpage_user to alert group view action?
    optional_slash_path("check_user_availability", CheckUserAvailability.as_view(), name="check_user_availability"),
    optional_slash_path("direct_paging", DirectPagingAPIView.as_view(), name="direct_paging"),
    optional_slash_path("unpage_user", UnpageUserAPIView.as_view(), name="unpage_user"),
]
