...
from apps.api.serializers.v1.schedule_calendar import ScheduleCalendarCreateSerializer, ScheduleCalendarSerializer
from apps.api.serializers.v1.schedule_ical import (
    ScheduleICalCreateSerializer,
    ScheduleICalSerializer,
    ScheduleICalUpdateSerializer,
)
from apps.api.serializers.v1.schedule_web import ScheduleWebCreateSerializer, ScheduleWebSerializer
