...
from apps.api.serializers.v1.user_group import UserGroupSerializer
...
class ScheduleBaseSerializer(EagerLoadingMixin, serializers.ModelSerializer):
    ...
    def get_on_call_now(self, obj):
        # Serializer context is set here: apps.api.views.v1.schedule.ScheduleView.get_serializer_context
