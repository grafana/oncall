...
@mock.patch(
    "apps.twilioapp.phone_provider.TwilioPhoneProvider._message_to_twiml_gather", return_value="twiml_gather_query"
)
def test_make_notification_call(mock_twiml, mock_call_create):
    ...
    mock_call_create.assert_called_once_with("twiml_gather_query", number, with_callback=True)
...
@mock.patch("apps.twilioapp.phone_provider.TwilioPhoneProvider._call_create", return_value=MockTwilioCallInstance())
@mock.patch(
    "apps.twilioapp.phone_provider.TwilioPhoneProvider._message_to_twiml_response", return_value="twiml_response_query"
)
def test_make_call(mock_twiml, mock_call_create):
    ...
    mock_call_create.assert_called_once_with("twiml_response_query", number, with_callback=False)
