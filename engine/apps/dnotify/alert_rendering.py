...
class AlertNotifyTemplater(AlertTemplater):
    RENDER_FOR_DESKTOP = "desktopdemo"  # needs to match the backend id!

    def _render_for(self):
        return self.RENDER_FOR_DESKTOP
...
def get_templated_fields(alert_group):
    ...
    templated_alert = AlertNotifyTemplater(alert).render()
