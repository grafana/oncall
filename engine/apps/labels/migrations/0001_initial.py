# Generated by Django 3.2.20 on 2023-09-25 07:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'unique_together': {('key_id', 'organization_id')},
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'unique_together': {('value_id', 'key_id')},
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key_cache', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='labels.labelkeycache')),
                ...
                ('value_cache', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='labels.labelvaluecache')),
            ],
            options={
