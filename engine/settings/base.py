...
BEAT_SCHEDULE_DB_FILENAME = os.getenv("BEAT_SCHEDULE_DB_FILENAME", "celerybeat-schedule")
if BEAT_SCHEDULE_DB_FILENAME:
    CELERY_BEAT_SCHEDULE_FILENAME = BEAT_SCHEDULE_DB_FILENAME
