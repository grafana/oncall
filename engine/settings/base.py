...
FEATURE_LABELS_ENABLED_FOR_ALL = getenv_boolean("FEATURE_LABELS_ENABLED_FOR_ALL", default=True)
# Enable labels feature for organizations from the list. Use OnCall org_id, for this flag
