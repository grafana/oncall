...
PHONE_PROVIDER = os.environ.get("PHONE_PROVIDER", "Twilio")

ASTERISK_ARI_ENDPOINT = os.environ.get("ASTERISK_ARI_ENDPOINT")
ASTERISK_ARI_APIKEY = os.environ.get("ASTERISK_ARI_APIKEY")
ASTERISK_ARI_CALLER_ID = os.environ.get("ASTERISK_ARI_CALLER_ID")
ASTERISK_ARI_CONTEXT = os.environ.get("ASTERISK_ARI_CONTEXT")
ASTERISK_ARI_EXTENSION = os.environ.get("ASTERISK_ARI_EXTENSION")
ASTERISK_ARI_TRUNK_NAME = os.environ.get("ASTERISK_ARI_TRUNK_NAME")
