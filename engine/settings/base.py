...
PHONE_PROVIDERS = {
    ...
    "zvonok": "apps.phone_notifications.zvonok_phone_provider.ZvonokPhoneProvider",
...
ZVONOK_API_KEY = os.environ.get("ZVONOK_API_KEY", default="")
ZVONOK_CALL_CAMPAIGN_ID = os.environ.get("ZVONOK_CALL_CAMPAIGN_ID", default="")
