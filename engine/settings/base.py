...
FEATURE_USER_WEBHOOK_ENABLED = getenv_boolean("FEATURE_USER_WEBHOOK_ENABLED", default=False)
...
USER_WEBHOOK_URL= os.getenv("USER_WEBHOOK_URL", None)
USER_WEBHOOK_TOKEN= os.getenv("USER_WEBHOOK_TOKEN", None)
USER_WEBHOOK_AUTH_HEADER = os.getenv("USER_WEBHOOK_AUTH_HEADER", None)

if FEATURE_USER_WEBHOOK_ENABLED:
    EXTRA_MESSAGING_BACKENDS += [("apps.user_webhook.backend.UserWebhookBackend", 9)]
