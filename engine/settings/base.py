...
FEATURE_LABELS_ENABLED = getenv_boolean("FEATURE_LABELS_ENABLED", default=False)  # enable for all
FEATURE_LABELS_ENABLED_FOR_ORGS = os.environ.get("FEATURE_LABELS_ENABLED_FOR_ORGS", default=list())  # enable for list
