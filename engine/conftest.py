...
from apps.auth_token.models import ApiAuthToken, IntegrationAuthToken, PluginAuthToken, SlackAuthToken
...
def make_token_for_integration():
    def _make_token_for_integration(alert_receive_channel, organization):
        return IntegrationAuthToken.create_auth_token(alert_receive_channel, organization)
