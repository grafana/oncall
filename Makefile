...
cleanup-k8s-images: ## NOTE: beta - remove all images generated by the helm release
	docker rmi oncall/engine:dev --force
	docker rmi oncall/ui:dev --force

cleanup-k8s-all: cleanup-k8s cleanup-k8s-images ## NOTE: beta - remove all k8s resources + images generated by the helm release
