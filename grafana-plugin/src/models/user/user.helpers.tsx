...
export class UserHelper {
  ...
  static async handleConnectGoogle() {
    // TODO: update this to use the openAPI autogenerated schema stuff
  ...
  static async handleDisconnectGoogle() {
    // TODO: update this to use the openAPI autogenerated schema stuff
    // @ts-ignore TODO: remove this
    const { data } = await onCallApi().GET('/disconnect/google-oauth2/', undefined);

    // TODO: handle the response status here.. if 200 it means it is completed, otherwise show some error msg to user
    console.log(data);

    // TODO: show user some sort of message here + update the user store
  }
}
