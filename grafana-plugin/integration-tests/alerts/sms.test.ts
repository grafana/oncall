...
import { GRAFANA_ADMIN_USERNAME } from '../utils/constants';
...
test.skip('we can verify our phone number + receive an SMS alert', async ({ page }) => {
  ...
  await createEscalationChain(page, escalationChainName, EscalationStep.NotifyUsers, GRAFANA_ADMIN_USERNAME);
