...
def test_errors():
    ...
    assert errors == [
        ...
        "Layer 6: Cannot migrate 1-weekly rotation with daily restrictions that split shifts.",
        "Layer 7: Cannot migrate 1-daily rotation with weekly restrictions that start at a different time than the shift start.",
        "Layer 8: Cannot migrate 7-hourly rotation with weekly restrictions that split shifts.",
        "Layer 9: Cannot migrate 7-hourly rotation with daily restrictions that split shifts.",
