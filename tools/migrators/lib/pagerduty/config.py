...
PAGERDUTY_MIGRATE_SERVICES = os.getenv("PAGERDUTY_MIGRATE_SERVICES", "false").lower() == "true"
...
PAGERDUTY_FILTER_USERS = os.getenv("PAGERDUTY_FILTER_USERS", "").split(",") if os.getenv("PAGERDUTY_FILTER_USERS") else []
