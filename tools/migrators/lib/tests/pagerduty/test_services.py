...
class TestTechnicalService(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(
            service.html_url, "https://example.pagerduty.com/service/SERVICE123"
        )
        self.assertEqual(
            service.self_url, "https://api.pagerduty.com/services/SERVICE123"
        )
        self.assertEqual(
            service.escalation_policy, {"id": "EP123", "name": "Test Policy"}
        )
    ...
    def test_str_representation(self):
        ...
        self.assertEqual(
            str(service), "TechnicalService(id=SERVICE123, name=Test Service)"
        )
...
class TestServiceFunctions(unittest.TestCase):
    ...
    def test_get_all_technical_services_with_metadata(
        self, mock_fetch_deps, mock_fetch_services
    ):
