...
class TestTransform(unittest.TestCase):
    ...
    def test_transform_technical_service(self):
        ...
        self.assertEqual(component["apiVersion"], "servicemodel.ext.grafana.com/v1alpha1")
        ...
        self.assertEqual(annotations["pagerduty.com/html-url"], "https://pagerduty.com/services/P123456")
        self.assertEqual(annotations["pagerduty.com/api-url"], "https://api.pagerduty.com/services/P123456")
    ...
    def test_transform_business_service(self):
        ...
        self.assertEqual(annotations["pagerduty.com/html-url"], "https://pagerduty.com/services/P789012")
        self.assertEqual(annotations["pagerduty.com/api-url"], "https://api.pagerduty.com/services/P789012")
