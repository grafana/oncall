...
{{% docs/reference %}}
[Configure alerts templates]: "/docs/oncall/ -> /docs/oncall/<ONCALL_VERSION>/integrations#templates"
[Configure alerts templates]: "/docs/grafana-cloud/ -> /docs/grafana-cloud/alerting-and-irm/oncall/integrations#templates"
{{% /docs/reference %}}
