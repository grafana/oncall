...
| `type`                             |                   Yes                    | One of: `wait`, `notify_persons`, `notify_person_next_each_time`, `notify_on_call_from_schedule`, `notify_user_group`, `resolve`, `notify_whole_channel`, `notify_if_time_from_to`.                                                                                                         |
...
| `notify_on_call_from_schedule`     | If type = `notify_on_call_from_schedule` | ID of a Schedule.                                                                                                                                                                                                                                                                           |
