...
1. Create API public key on Profile->Settings page and assign it's value to `ZVONOK_API_KEY`.
1. Create Calls by API campaign and assign it's ID value to `ZVONOK_CALL_CAMPAIGN_ID`.
